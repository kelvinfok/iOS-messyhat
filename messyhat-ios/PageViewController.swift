...
class PageViewController: UIPageViewController {
    ...
    var pageDescriptions = ["MessyHat is a barter network for people to trade and learn new skills from one another.", "Create a profile, browse through members profiles, arrange meet-ups and connect with skilled people.", "Network with people around the world and kickstart exciting projects together."]
