...
class PageViewController: UIPageViewController {
    ...
    var pageDescriptions = ["MessyHat is a barter network for members to trade and learn new skills without using money.", "Create a profile, browse through members profiles, arrange meetups and exchange skills.", "Find awesome people and start exciting projects together."]
